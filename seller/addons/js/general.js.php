...
var sdar="<?=file_location('seller_ajax_url','')?>";
...
<?php } ?>
<?php //for getting inbox number?>
gnc('noti');function gnc(t){$.ajax({type:'GET',url:sdar+'get/gnc/'+t,cache:false}).done(function(s){$('.ntf').html(s);})}