...
if(isset($_SESSION['selller_id'])){require_once(file_location('seller_inc_path','session_destroy.inc.php'));}
...
<?php require_once(file_location('inc_path','page_load.inc.php')); //page load?>
	<center>
		...
		<div class="j-round j-panel j-border j-border-color5"style="width:100%;max-width:400px;height:auto;">
			...
			<span class="j-text-color1 j-large"style='line-height:50px'>
				...
				<br><b class='j-bolder j-text-color5'>SELLER LOGIN</b>
			</span><br>
			<form id='lgform'onsubmit="event.preventDefault();">
				<br>
				...
				<input type="hidden"name="re"id="re"value="<?=isset($_GET['re'])?($_GET['re']):file_location('seller_url','');?>">
				<a class="j-right j-text-color3 j-bolder"href="<?=file_location('seller_url','forgot_password/');?>">Forget Your Password?</a><br class='j-clearfix'><br>
				<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-left j-bolder"style='width:100%;'>Log In As Seller</button>
	...
	<span id='st'></span>
<?php require_once(file_location('seller_inc_path','js.inc.php'));?>
</body>
</html>