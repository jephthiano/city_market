...
$page_url = file_location('seller_url','order/'.$_GET['type'].'/');
	...
	<div class='j-row j-home-padding'style='padding-top:0px;'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<div class='j-color4'>
					<?php get_header('ORDERS','back','','seller_url')?>
					<?php $user = 'seller'; require_once(file_location('inc_path','orders_link_header.inc.php')); //order?>
					<br>
				</div>
			</div>
		</div>
