...
$page_url = file_location('seller_url','/product/insert_product/');
$page = "UPLOAD PRODUCT";
	...
	<div class='j-home-padding'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<div class='j-padding'>
					<h2 class='j-text-color1 j-padding j-color6'><b>UPLOAD NEW PRODUCT</b></h2>
				</div>
				<div class='j-padding'>
					<a href="<?=file_location('seller_url','product/available/')?>" class="j-btn j-color1 j-right j-round j-card-4 j-bolder">Show Available Product</a>
					<br class='j-clearfix'>
				</div>
					...
					<form onsubmit="event.preventDefault();"id='insfd'enctype="multipart/form-data">
						...
						<div class='j-row'>
							<div class='j-col m6 j-padding'>
								...
								<select name='ct'class='j-select j-color4 j-round j-border-2 j-border-color5'style="width:100%;"onchange="gscd(this.value,0);">
									<option value=''>Select category</option><?php get_category()?><option value='0'>Others</option>
								</select>
							</div>
							<div class='j-col m6 j-padding'>
						...
						<div class='j-margin'>
							<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-bolder">Upload Product</button>
						</div>
					</form>
				</div>
			</div>
