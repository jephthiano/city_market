...
$page_url = file_location('seller_url','account/change_password/');
	...
	<div class='j-row j-home-padding'style='padding-top:0px;'>
		...
		<div class='j-col l8 xl9 j-padding-flexible'>
			<div class='j-color4 j-account-height'>
				<?php get_header('CHANGE PASSWORD','account/','','seller_url')?>
				<div class='j-padding'>
					<form onsubmit="event.preventDefault();"class=''id='chspsfrm'>
