...
<?php if(php_self('/login.enc.php','admin')){ ?>
<?php //login ?>
...
<?php } ?>
<?php if(php_self('/admin/index.php','admin')){ ?>
...
<?php } ?>
<?php if(php_self('/admin/insert_admin.enc.php','admin')){ ?>
...
<?php } ?>
<?php if(php_self('/admin/profile.enc.php','admin')){ ?>
<?php //delete account ?>
function da(d){
...
<?php } ?>
<?php if(php_self('/admin/preview_admin.enc.php','admin')){ ?>
<?php //update level ?>
...
<?php } ?>
<?php if(php_self('/admin/edit_profile.enc.php','admin')){ ?>
<?php //edit_profile ?>
$(document).ready(function(){
...
<?php } ?>
<?php if(php_self('/admin/change_password.enc.php','admin')){ ?>
<?php //change_password ?>
$(document).ready(function(){
