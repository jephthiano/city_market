...
<?php if(php_self('/social_handle/index.php','admin')){ ?>
...
<?php } ?>
<?php if(php_self('/social_handle/insert_social_handle.enc.php','admin')){ ?>
...
<?php } ?>
<?php if(php_self('/social_handle/update_social_handle.enc.php','admin')){ ?>
