			...
			<br class='j-clearfix'><br>
				...
				if($order_id === false){
					...
					<div class='j-col m5 j-padding'>
						...
						<div class='j-color5'><div class='j-padding j-large'><b>Payment Made</b></div></div>
						...
						<?php
						$seller_id = content_data('order_table','s_id',$order_id,'or_order_id','','null');
						...
						<div class='j-padding j-color4'>
							...
							<div class=''style='line-height: 40px;'>
								<div>
									<span class='j-bolder j-text-color7'>Rep:</span>
								...
								<div>
									<span class='j-bolder j-text-color7'>Ph Number 1:</span>
									<span class='j-text-color7'><?=content_data('seller_contact_table','sc_phnumber1',$seller_id,'s_id','','null')?></span>
								</div>
								<div>
									<span class='j-bolder j-text-color7'>Ph Number 2:</span>
									<span class='j-text-color7'><?=content_data('seller_contact_table','sc_phnumber2',$seller_id,'s_id','','null')?></span>
								</div>
							</div>
						</div>
						<br>
						...
						if($cur_status === 'cancelled'){
							?>
							<div class='j-color5'><div class='j-padding j-large'><b>Cancel Details</b></div></div>
							<div class='j-padding j-color4'>
						...
						<div class='j-color5'><div class='j-padding j-large'><b>Order History</b></div></div>
						<div class='j-padding j-color4'>
						...
						if(content_data('order_table','or_payment_received',$order_id,'or_order_id') === 'yes'){
							?>
							<div class='j-color5'><div class='j-padding j-large'><b>Transaction Summary</b></div></div>
							<div class='j-padding j-color4'>
