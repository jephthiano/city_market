...
$page_url = file_location('admin_url','/category/insert_subcategory/');
$page = "INSERT SUB CATEGORY";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div class='j-padding'>
			<h2 class='j-text-color1 j-padding j-color4'><b>INSERT SUB NEW CATEGORY</b></h2>
		</div>
		<div class='j-padding'>
			<a href="<?=file_location('admin_url','category/subcategory/')?>" class="j-btn j-color1 j-right j-round j-card-4 j-bolder">Show All Sub Category</a>
			<br class='j-clearfix'>
		</div>
		<div id=""class='j-color4'style='padding-top: 9px;'>
			...
			<form onsubmit="event.preventDefault();"id='insscg'class=''>
				...
				<div class='j-row'>
					<div class='j-col m6 j-padding'>
						...
						name="sct"id="sct"value=""style="width:100%;"/><br>
				...
				<div class='j-margin'>
					<button type='submit'id='sbtn'class="j-btn j-medium j-color1 j-round j-bolder">Insert Sub Category</button>
				</div>
			</form>
			<span id="st"></span>
			<br><br>
