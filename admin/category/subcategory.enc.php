...
$page_url = file_location('admin_url','category/subcategory/');
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			<div class='j-padding'>
				<h2 class='j-text-color1 j-padding j-color4'><b>SUB CATEGORY LIST</b></h2>
			</div>
			<center>
				<div class='j-padding'>
					<?php if($adlevel > 1){?>
					<a href="<?=file_location('admin_url','category/')?>"class='j-margin j-btn j-color1 j-left j-round j-card-4'><b>All Category</b></a>
					<a href="<?=file_location('admin_url','category/insert_subcategory/')?>"class='j-margin j-btn j-color1 j-round j-card-4'><b>Insert New Sub Category</b></a>
				...
				<div class="j-container">
					...
					placeholder="Search sub category"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="gscr(<?=$page_num?>);"onkeyup="gscr(<?=$page_num?>);"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
