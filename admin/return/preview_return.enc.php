		...
		<div class='j-row'>
			...
			if($id === false){
				...
				<div id=""class='j-col m7 j-padding'>
					<div class='j-color7'><div class='j-padding j-large'><b>Return Details</b></div></div>
					<div class="j-container j-color4 j-padding">
						...
						?>
						<div class='j-text-color7 j-bolder j-large j-text-color1' style='margin-bottom:9px;'>RETURN DETAILS</div>
					...
					<div class='j-color2'><div class='j-padding j-large'><b>Customer Details</b></div></div>
					<div class="j-container j-color4 j-padding">
						<div class='j-row'style='margin-bottom:10px;'>
				...
				<div id=""class='j-col m5 j-padding'>
					...
					<div class='j-color3'><div class='j-padding j-large'><b>Return History</b></div></div>
					<div class="j-container j-color4 j-padding">
