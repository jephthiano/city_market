...
$page_url = file_location('admin_url','log/admin_log/'.$_GET['page'].'/');
$page = "MANAGE ADMIN LOGS";
...
<div class="j-row">
	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			<div class='j-padding'>
				<h2 class='j-text-color1 j-padding j-color4'><b>ADMIN LOGS LIST</b></h2>
			</div>
			<center>
				<div class="j-container">
					<input type="search"name="sx"id="sx"class="j-input j-border-2 j-border-color1 j-round"
					placeholder="Search admin all logs"style="width:96%;max-width:500px;outline:none;display:inline"onsearch="galr(<?=$page_num?>);"onkeyup="galr(<?=$page_num?>);"/>
				</div>
				<div id="shr"></div>
			</center>
			<span id="st"></span>
