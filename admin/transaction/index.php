		...
		<div id="maincol">
			...
			<center>
				<div class="j-container">
					...
					<a href="<?=file_location('admin_url','transaction/daily/'.process_day().'/')?>"class='j-btn j-color2 j-text-color4 j-round j-container j-margin-cpanel'style="padding:20px 40px;">
						<b><span class='j-large'>Today</span></b><br><b><span class='j-large'>Transaction</span></b>
					</a>
					<a href="<?=file_location('admin_url','transaction/annual/all/')?>"class='j-btn j-color3 j-text-color4 j-round j-container j-margin-cpanel'style="padding:20px 40px;">
						<b><span class='j-large'>Annual</span></b><br><b><span class='j-large'>Transactions</span></b>
					</a>
					<a href="<?=file_location('admin_url','transaction/monthly/all/')?>"class='j-btn j-color5 j-text-color4 j-round j-container j-margin-cpanel'style="padding:20px 40px;">
						<b><span class='j-large'>Monthly</span></b><br><b><span class='j-large'>Transactions</span></b>
					</a>
					<a href="<?=file_location('admin_url','transaction/daily/all/')?>"class='j-btn j-color7 j-text-color4 j-round j-container j-margin-cpanel'style="padding:20px 40px;">
						<b><span class='j-large'>Daily</span></b><br><b><span class='j-large'>Transactions</span></b>
					</a>
					<a href="<?=file_location('admin_url','transaction/stats/')?>"class='j-btn j-color2 j-text-color4 j-round j-container j-margin-cpanel'style="padding:20px 40px;">
