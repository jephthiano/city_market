			...
			<div class="j-container">
				...
				<div class='j-padding j-color4'>
					...
					<div class='j-padding j-text-color3 j-bolder'>
						...
						<div><span class='j-large'style='padding-right: 5px;'>⨀</span> <span>Clear recent view more than 30 days in the database</span></div>
						<div><span class='j-large'style='padding-right: 5px;'>⨀</span> <span>Clear expired customer email code in database</span></div>
						<div><span class='j-large'style='padding-right: 5px;'>⨀</span> <span>Clear expired seller email code in database</span></div>
					</div>
				</div>
			</div>
		</div>
