	...
	<div class="j-col s12 l10"id='mainbody'>
		...
		<div id="maincol">
			...
			<div class="j-padding">
				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						<div class='j-color5'><div class='j-padding j-large'><b>User's Activities Setting</b></div></div>
						<div class='j-padding '>
							<div class='j-row'>
								<div class='j-col m6'>
				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						<div class='j-color5'><div class='j-padding j-large'><b>Seller's Activities Setting</b></div></div>
						<div class='j-padding '>
							<div class='j-row'>
								<div class='j-col m6'>
									<span class='j-bolder j-text-color7'>All Activities:</span>
									<span><?php if(get_json_data('all','seller_act') == 1){echo 'Enabled';}else{echo 'Disabled';}?></span>
								</div>
								<div class='j-col m6'>
									<span class='j-bolder j-text-color7'>Website Surfing:</span>
									<span><?php if(get_json_data('surfing','seller_act') == 1){echo 'Enabled';}else{echo 'Disabled';}?></span>
								</div>
							</div>
							<br>
							<div class='j-row'>
								<div class='j-col m6'>
									<span class='j-bolder j-text-color7'>Login:</span>
									<span><?php if(get_json_data('login','seller_act') == 1){echo 'Enabled';}else{echo 'Disabled';}?></span>
								</div>
							</div>
							<br>
						</div>
