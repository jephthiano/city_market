		...
		<div id="maincol">
			...
			<div class="j-container">
				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						<div class='j-color5'><div class='j-padding j-large'><b>User Activity Settings</b></div></div>
						<div class='j-padding '>
							<div class='j-row'>
								<div class='j-col m6'>
									<?php //keywords ?>
				...
				<div class=''style='margin:15px 0px;'>
					<div class='j-color4'>
						<div class='j-color5'><div class='j-padding j-large'><b>Seller Activity Settings</b></div></div>
						<div class='j-padding '>
							<div class='j-row'>
								<div class='j-col m6'>
									<?php //keywords ?>
									...
									<div class='j-bolder'>
										<span style='margin-right:15px;'>
											<span>Status: </span>
											<span class='j-text-color5'><?php $status = get_json_data('all','seller_act');?><?=$status == 1?"Enabled":"Disabled";?></span>
										</span>
										<span class='j-btn j-color1 j-round'onclick="css('seller_act','all','<?=$status == 1?0:1;?>');">
											<?=$status == 1?"Disable":"Enable";?>
										</span>
									</div>
								</div>
								<div class='j-col m6'>
									...
									<div class='j-bolder'>
										<span style='margin-right:15px;'>
											<span>Status: </span>
											<span class='j-text-color5'><?php $status = get_json_data('surfing','seller_act');?><?=$status == 1?"Enabled":"Disabled";?></span>
										</span>
										<span class='j-btn j-color1 j-round'onclick="css('seller_act','surfing','<?=$status == 1?0:1;?>');">
											<?=$status == 1?"Disable":"Enable";?>
										</span>
									</div>
								</div>
							...
							<div class='j-row'>
								<div class='j-col m6'>
									...
									<div class='j-bolder'>
										<span style='margin-right:15px;'>
											<span>Status: </span>
											<span class='j-text-color5'><?php $status = get_json_data('login','seller_act');?><?=$status == 1?"Enabled":"Disabled";?></span>
										</span>
										<span class='j-btn j-color1 j-round'onclick="css('seller_act','login','<?=$status == 1?0:1;?>');">
											<?=$status == 1?"Disable":"Enable";?>
										</span>
									</div>
								</div>
