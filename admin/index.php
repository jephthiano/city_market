		...
		<div id="maincol">
			<center>
				...
				<div class='j-container j-medium'>
					...
					<div class='j-margin j-show-inline-block'>
						<a href="<?=file_location('admin_url','request/request/update account/pending/')?>"class='j-text-color4 j-color1 j-btn j-round j-bolder j-itallic'>
						...
						<i class='<?=icon('edit')?>'></i> Update Profile Request (<?=$numrow?>)
						</a>
					</div>
					<div class='j-margin j-show-inline-block'>
						<a href="<?=file_location('admin_url','request/request/delete account/pending/')?>"class='j-text-color4 j-color1 j-btn j-round j-bolder j-itallic'>
						...
						<i class='<?=icon('trash')?>'></i> Delete Account Request (<?=$numrow?>)
						</a>
					</div>
					<div class='j-margin j-show-inline-block'>
						<a href="<?=file_location('admin_url','request/request/become seller/pending/')?>"class='j-text-color4 j-color1 j-btn j-round j-bolder j-itallic'>
						...
						<i class='<?=icon('trash')?>'></i> Become Seller Request (<?=$numrow?>)
						</a>
					</div>
				</div>
				<div class="j-container">
					...
					<b><span class=''>Admins</span><span class='j-padding'>(<?=get_numrow('admin_table')?>)</span></b>
					<br>
					<span style='margin-top:5px;'class="j-large <?=icon('users')?>"> </span> 
					</a>
					<a href="<?=file_location('admin_url','seller/all/')?>"class='j-btn j-color1 j-text-color4 j-round j-container j-margin-cpanel'style="padding:10px 20px;">
					<b><span class=''>Sellers</span><span class='j-padding'>(<?=get_numrow('seller_table')?>)</span></b>
					<br>
					<span style='margin-top:5px;'class="j-large <?=icon('users')?>"> </span> 
					</a>
					<?php }?>
					...
					<?php } ?>
					<a href="<?=file_location('admin_url','request/')?>"class='j-btn j-color1 j-text-color4 j-round j-container j-margin-cpanel'style="padding:10px 20px;">
					<b><span class=''>Request</span></b>
					<br>
