...
<?php //for getting cart/inbox notification counter?>
...
<?php } ?>
<?php if(php_self('/product/index.php','home')){?>
<?php //slidehow//?>
var slideIndex = 1;
sD(slideIndex);
...
<?php } ?>
<?php if(php_self('/product/index.php','home') || php_self('/checkout/index.php','home') || php_self('/cart.enc.php','home')
         || (isset($nav) && $nav === 'nav' )){?>
